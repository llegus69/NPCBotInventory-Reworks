...
local SLOT_LAYOUT = {
    { name = "Head",      label = "Head",        x = -120, y =  145 },
    { name = "Neck",      label = "Neck",        x = -120, y =   98 },
    { name = "Shoulder",  label = "Shoulder",    x = -120, y =   51 },
    { name = "Back",      label = "Back",        x = -120, y =    4 },
    { name = "Chest",     label = "Chest",       x = -120, y =  -43 },
    { name = "Shirt",     label = "Shirt",       x = -120, y =  -90 },
    { name = "Tabard",    label = "Tabard",      x = -120, y = -137 },
    { name = "Wrist",     label = "Wrist",       x = -120, y = -184 },
    { name = "Hands",     label = "Hands",       x =  106, y =  145 },
    { name = "Waist",     label = "Waist",       x =  106, y =   98 },
    { name = "Legs",      label = "Legs",        x =  106, y =   51 },
    { name = "Feet",      label = "Feet",        x =  106, y =    4 },
    { name = "Finger1",   label = "Ring 1",      x =  106, y =  -43 },
    { name = "Finger2",   label = "Ring 2",      x =  106, y =  -90 },
    { name = "Trinket1",  label = "Trinket 1",   x =  106, y = -137 },
    { name = "Trinket2",  label = "Trinket 2",   x =  106, y = -184 },
    { name = "MainHand",  label = "Main Hand",   x = -120, y = -231 },
    { name = "OffHand",   label = "Off Hand",    x =  106, y = -231 },
    { name = "Ranged",    label = "Ranged",      x =    3, y = -231 },
}
...
centerBg:SetPoint("CENTER", inspectFrame, "CENTER", -7, -20)
